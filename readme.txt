•Restaurant simulation program in C++.

The project was based on object-oriented system that simulates a restaurant management:
...
The program will get a configuration file as an input, which includes all required information about the
